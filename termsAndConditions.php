		...
		<section class="page-content">
			<div class="hero pad">
                ...
                <h4>Late or missing refunds (if applicable)</h4>
								<p>If you haven’t received a refund yet, first check your bank account again. <br> Then contact your credit card company, it may take some time before your refund is officially posted.<br> Next contact your bank. There is often some processing time before a refund is posted. If you’ve done all of this and you still have not received your refund yet, please contact us at choicepark@gmail.com.</p>
		            <br>
                <h4>Restrictions</h4>
								<p>You are specifically restricted from all of the following:</p>
                <p>1. publishing any Website material in any other media;<br>2. selling, sublicensing and/or otherwise commercializing any Website material;<br>3. publicly performing and/or showing any Website material;<br>4. using this Website in any way that is or may be damaging to this Website;<br>5. using this Website in any way that impacts user access to this Website;<br>6. using this Website contrary to applicable laws and regulations, or in any way may cause harm to the Website, or to any person or business entity;<br>7. engaging in any data mining, data harvesting, data extracting or any other similar activity in relation to this Website;<br>8. using this Website to engage in any advertising or marketing.</p><br>
                ...
                <h4>Your Content</h4>
                <p>In these Website Standard Terms and Conditions, “Your Content” shall mean any audio, video text, images or other material you choose to display on this Website. By displaying Your Content, you grant Company Name a non-exclusive, worldwide irrevocable, sub licensable license to use, reproduce, adapt, publish, translate and distribute it in any and all media.Your Content must be your own and must not be invading any third-party's rights. Company Name reserves the right to remove any of Your Content from this Website at any time without notice.</p>
                <br>
                <h4>No warranties</h4>
								...
								<div class="col-md-12">
									<div class="subscribe">
										<div class="subscribe-brief">
											...
											<p>There are many offers available, Subscribe to get the offers.</p>
										</div>
